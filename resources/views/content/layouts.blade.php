...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ url('/public/template') }}/styles/jquery-ui-1.10.4.custom.min.css">
    ...
    <link type="text/css" rel="stylesheet" href="{{ url('/public/template') }}/styles/zabuto_calendar.min.css">
    <link type="text/css" rel="stylesheet" href="{{ url('/public/template') }}/styles/pace.css">
    <link type="text/css" rel="stylesheet" href="{{ url('/public/template') }}/styles/jquery.news-ticker.css">
</head>
<body>
    <div>
        <!--BEGIN THEME SETTING-->
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" class="navbar navbar-default navbar-static-top">
                <div class="navbar-header">
                    ...
                    <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">Restoran</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
                                                    ...
                                                    <div class="chat-content">
                                                        <ul class="chat-box-body">
                                                            <li>
                                                                ...
                                                                <script src="{{ url('/public/template') }}/script/jquery-1.10.2.min.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery-migrate-1.2.1.min.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery-ui.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/bootstrap.min.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/bootstrap-hover-dropdown.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/html5shiv.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/respond.min.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.metisMenu.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.slimscroll.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.cookie.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/icheck.min.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/custom.min.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.news-ticker.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.menu.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/pace.min.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/holder.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/responsive-tabs.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.flot.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.flot.categories.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.flot.pie.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.flot.tooltip.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.flot.resize.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.flot.fillbetween.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.flot.stack.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/jquery.flot.spline.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/zabuto_calendar.min.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/index.js"></script>
                                                                <!--LOADING SCRIPTS FOR CHARTS-->
                                                                <script src="{{ url('/public/template') }}/script/highcharts.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/data.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/drilldown.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/exporting.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/highcharts-more.js"></script>
                                                                <script src="{{ url('/public/template') }}/script/charts-highchart-pie.js"></script>
                                                                <script src="script/charts-highchart-more.js"></script>
                                                                <!--CORE JAVASCRIPT-->
                                                                <script src="{{ url('/public/template') }}/script/main.js"></script>
