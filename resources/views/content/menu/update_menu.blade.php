			...
			<form method="POST" action="{{ url('/update_menu') }}" enctype="multipart/form-data">
				...
				<div class="form-body pal">
					...
					<div class="form-group">
						...
						<img src="{{ url('/public/img_menu/'.$edit->foto_menu) }}" style="width: 100%;">
					</div>
					<div class="form-group">
				...
				<tbody>
					...
					@foreach($data_menu as $menu)
						<tr>
							...
							<td class="text-center">{{ $menu->relasi_ke_kategori->nama_kategori }}</td>
							<td class="text-center">Rp. {{ number_format($menu->harga_menu) }}</td>
							<td class="text-center">
								<img src="{{ url('/public/img_menu/'.$menu->foto_menu) }}" width="30">
							</td>
							<td class="text-center">
